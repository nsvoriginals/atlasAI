...
export default function Navbar() {
  ...
  return (
    <div className="sticky top-0 z-50 bg-white/10 backdrop-blur-lg hover:bg-white/20 border-b border-gray-300/30 shadow-sm max-w-screen-xl mx-auto py-4 md:py-6 px-4 md:px-10 flex items-center rounded-full">
      {/* Logo */}
      <h1 
        className="font-base text-2xl font-bold flex-1 md:mr-24 cursor-pointer" 
        onClick={() => navigate('/')}
      >
        Atlas
      </h1>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-gray-200 shadow-lg rounded-b-2xl md:hidden">
