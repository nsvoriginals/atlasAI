export const Features = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center font-satoshi gap-20 px-4 py-10">
      ...
      {[
        ...
        >
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left px-4">
            ...
            <p className="mt-3 text-base sm:text-lg md:text-xl text-black max-w-xl">
              {text}
            </p>
          </div>
        </div>
